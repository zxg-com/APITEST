...
xls = common.get_xls("pc.xlsx", "删除备注")  # excel取值
...
class UpdateRemark(unittest.TestCase):
    def setParameters(self, case_name, url, method,id,isValid,msg ):
    ...
    def testUpdateRemark(self):
        ...
        # 设置参数
        remarkid = ReadConfig.get_case('remarkid')
        paramJson = {"id":remarkid,"isValid":self.isValid}
