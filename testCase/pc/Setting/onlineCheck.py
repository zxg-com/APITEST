...
xls = common.get_xls("pc.xlsx", "在线状态检查")  # excel取值
...
class onlineCheck(unittest.TestCase):
    def setParameters(self, case_name, url, method, customerId,firstResult,maxResult,isValid,msg ):
