...
import requests
triage3_xls = common.get_xls("pc.xlsx", "重新分诊列表")   #excel取值
...
@paramunittest.parametrized(*triage3_xls)
class Triagelist3(unittest.TestCase):
    ...
    def testTriagelist3(self):
        ...
        s={"conType":self.conType,"triageType":self.triageType,"sortType":self.sortType}
