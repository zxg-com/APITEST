...
xls = common.get_xls("pc.xlsx", "接诊释放列表更新")  # excel取值
...
class listUpdata(unittest.TestCase):
    def setParameters(self, case_name, url, method,consultationIds,consultationState,customerId,consultationType,msg ):
        ...
        self.consultationType=int(consultationType)
        self.msg = str(msg)
    ...
    def testlistUpdata(self):
        ...
        s= {"consultationIds":consultationIds,
