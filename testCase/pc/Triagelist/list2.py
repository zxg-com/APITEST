...
import requests
triage2_xls = common.get_xls("pc.xlsx", "沟通中列表")   #excel取值
...
@paramunittest.parametrized(*triage2_xls)
class Triagelist2(unittest.TestCase):
    def setParameters(self, case_name, url,method,conType,triageType,sortType,msg):
    ...
    def testTriagelist2(self):
        ...
        s={"customerId":str(customerID),"conType":self.conType,"triageType":self.triageType,"sortType":self.sortType}
