...
xls = common.get_xls("pc.xlsx", "添加常用回复")  # excel取值
...
class CreatePhrase(unittest.TestCase):
    def setParameters(self, case_name, url, method,customerId,replyContent,isValid, msg ):
    ...
    def checkResult(self):
        ...
        ReadConfig.set_im('replyid',self.info['responseObject']['responsePk'])
        # 显示返回结果
