...
xls = common.get_xls("pc.xlsx", "新增快捷提问分组")  # excel取值
...
class CreateAskGroup(unittest.TestCase):
    def setParameters(self, case_name, url, method,customerId,treeLevel,isValid,id,questionDesc,questionId,questionType,msg ):
    ...
    def checkResult(self):
        ...
        #存入分组id
        ReadConfig.set_im('question_groupid', self.info['responseObject']['responseData']['dataList']['questionId'])
