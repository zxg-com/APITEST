...
xls = common.get_xls("pc.xlsx", "删除快捷提问")  # excel取值
...
class DeleteAsk(unittest.TestCase):
    def setParameters(self, case_name, url, method, isValid,questionId,msg, ):
    ...
    def testDeleteAsk(self):
        ...
        paramJson = {"isValid":self.isValid,"questionId":questionId}
