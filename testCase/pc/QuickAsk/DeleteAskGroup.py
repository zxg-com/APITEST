...
xls = common.get_xls("pc.xlsx", "删除快捷提问分组")  # excel取值
...
class DeleteAskGroup(unittest.TestCase):
    def setParameters(self, case_name, url, method, isValid,questionId,isBatch,msg, ):
        self.case_name = str(case_name)
        self.method = str(method)
        self.isValid = str(isValid)
        self.isBatch=int(isBatch)
        self.msg = str(msg)
    ...
    def testDeleteAskGroup(self):
        ...
        # 设置参数
        questionId = ReadConfig.get_im('question_groupid')
        paramJson = {"isValid":self.isValid,"questionId":questionId,"isBatch":self.isBatch}
