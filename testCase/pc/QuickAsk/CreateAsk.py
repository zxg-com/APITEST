...
xls = common.get_xls("pc.xlsx", "新建快捷提问")  # excel取值
...
class CreateAsk(unittest.TestCase):
    def setParameters(self, case_name, url, method,customerId,treeLevel	,isValid,questionDesc,parentId,fullPath	,questionType,msg ):
    ...
    def testCreateAsk(self):
        ...
        parentId=ReadConfig.get_im('question_groupid')
