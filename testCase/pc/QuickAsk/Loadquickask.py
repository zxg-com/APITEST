...
xls = common.get_xls("pc.xlsx", "获取快捷提问")  # excel取值
...
class Loadquickask(unittest.TestCase):
    def setParameters(self, case_name, url, method, sessionCustomerId,isValid,firstResult,maxResult,sortType,sortPartIdList,msg ):
        ...
        self.sortPartIdList = str(sortPartIdList)
        self.msg = str(msg)
    ...
    def testquickask(self):
        ...
        # 设置参数
        sessionCustomerId=ReadConfig.get_customer('customerid')
        paramJson={"sessionCustomerId":sessionCustomerId,
                   "isValid":self.isValid,
                   "firstResult":self.firstResult,
                   "maxResult":self.maxResult,
                   "sortType":self.sortType,
                   "sortPartIdList":self.sortPartIdList}
