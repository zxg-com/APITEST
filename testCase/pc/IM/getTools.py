...
xls = common.get_xls("pc.xlsx", "工具栏")  # excel取值
...
class gettools(unittest.TestCase):
    def setParameters(self, case_name, url, method, deviceType,sortType,visitSiteId,msg):
    ...
    def testgetTools(self):
        ...
        # 设置参数
        paramJson = {"deviceType":self.deviceType, "sortType":self.sortType, "visitSiteId":self.visitSiteId}
