...
xls = common.get_xls("pc.xlsx", "初诊建议获取专业")  # excel取值
...
class GetTablist(unittest.TestCase):
    ...
    def checkResult(self):
        ...
        self.assertEqual(self.info['responseObject']['responseData']['data_list'][0]['tagName'], self.msg)
