...
xls = common.get_xls("pc.xlsx", "初诊建议获取疾病")  # excel取值
...
class Getillnesslist(unittest.TestCase):
    def setParameters(self, case_name, url, method, isValid	,firstResult,maxResult	,illnessName,isSolr,msg ):
        self.case_name = str(case_name)
        self.method = str(method)
        self.isValid = int(isValid)
        self.firstResult = int(firstResult)
        self.maxResult = int(maxResult)
        self.isSolr = int(isSolr)
        self.msg = str(msg)
    ...
    def testGetillnesslist(self):
        ...
        # 设置参数
        paramJson = {"isValid":self.isValid,"firstResult":self.firstResult,"maxResult":self.maxResult,"isSolr":self.isSolr}
        data = {
    ...
    def checkResult(self):
        ...
        #self.assertEqual(self.info['responseObject']['responseData']['dataList'][0]['illnessName'], self.msg)
