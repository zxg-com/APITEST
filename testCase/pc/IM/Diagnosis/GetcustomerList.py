...
xls = common.get_xls("pc.xlsx", "全部医生列表")  # excel取值
...
class GetcustomerList(unittest.TestCase):
    def setParameters(self, case_name, url, method, isMatch,isValid,logoUseFlag,firstResult,maxResult,illnessId	,areasExpertise,patientId,searchParam,searchAreasExpertise,degreeType,searchOnlineState,msg):
        ...
        self.searchOnlineState = int(searchOnlineState)
        self.msg = str(msg)
    ...
    def testGetcustomerList(self):
        ...
        paramJson = {'isMatch': self.isMatch, 'isValid': self.isValid, 'logoUseFlag': self.logoUseFlag,
                     ...
                     'searchOnlineState': self.searchOnlineState}
