...
xls = common.get_xls("pc.xlsx", "患教知识列表")  # excel取值
...
class GetKnowledge(unittest.TestCase):
    def setParameters(self, case_name, url, method, isValid,firstResult,maxResult,msg):
    ...
    def testGetKnowledge(self):
        ...
        # 设置参数
        paramJson = {"isValid":self.isValid,"firstResult":self.firstResult,"maxResult":self.maxResult}
        data = {
