...
xls = common.get_xls("pc.xlsx", "推荐医生信息")  # excel取值
...
class Recommened(unittest.TestCase):
    def setParameters(self, case_name, url, method, caseId,patientId,customerId,recommendCustomerList,diagnosisId,type,msg ):
        self.case_name = str(case_name)
        self.method = str(method)
        self.recommendCustomerList = str(recommendCustomerList)
        self.type=int(type)
        self.msg = str(msg)
    ...
    def testRecommened(self):
        ...
        diagnosisId = ReadConfig.get_case('dianosisid')
        paramJson = {"caseId":caseId,"patientId":patientId,"customerId":customerId,
                     "recommendCustomerList":self.recommendCustomerList,
                     "diagnosisId":diagnosisId,"type":self.type}
        data = {
