...
xls = common.get_xls("pc.xlsx", "更新工单状态")  # excel取值
...
class UpdateCons(unittest.TestCase):
    def setParameters(self, case_name, url, method, consultationIds,consultationState,customerId,consultationType,msg, ):
        self.case_name = str(case_name)
        self.method = str(method)
        self.consultationState = int(consultationState)
    ...
    def testUpdateCons(self):
        ...
        consultationIds = ReadConfig.get_case('consultationid')
        # 设置参数
        paramJson = {"consultationIds":consultationIds,
                     "consultationState":self.consultationState,
                     "customerId":customerId,
                     "consultationType":self.consultationType}
        data = {
