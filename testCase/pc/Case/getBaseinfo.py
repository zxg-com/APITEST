...
xls = common.get_xls("pc.xlsx", "患者病例基本信息")  # excel取值
...
class getBaseinfo(unittest.TestCase):
    def setParameters(self, case_name, url, method, isValid,firstResult,maxResult,patientId,msg ):
    ...
    def testgetBaseinfo(self):
        ...
        paramJson = {"isValid":self.isValid, "firstResult":self.firstResult, "maxResult":self.maxResult, "patientId":patientId}
        data = {
    ...
    def checkResult(self):
        ...
        ReadConfig.set_patient('baseinfo_id',self.info['responseObject']['responseData']['dataList'][0]['id'])
        # 显示返回结果
