...
xls = common.get_xls("pc.xlsx", "现病史")  # excel取值
...
class getHpi(unittest.TestCase):
    def setParameters(self, case_name, url, method, caseId,msg ):
    ...
    def checkResult(self):
        ...
        ReadConfig.set_case('hpi_id', self.info['responseObject']['responseData']['dataList'][0]['id'])
        # 显示返回结果
