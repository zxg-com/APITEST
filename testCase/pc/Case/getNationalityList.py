...
xls = common.get_xls("pc.xlsx", "民族数据")  # excel取值
...
class A(unittest.TestCase):
    ...
    def test(self):
        ...
        # 设置参数
        paramJson = {"isValid": self.isValid,
    ...
    def checkResult(self):
        ...
        self.assertEqual(self.info['responseObject']['responseData']['dataList'][0]['nationality'], self.msg)
