...
xls = common.get_xls("pc.xlsx", "体格检查")  # excel取值
...
class getPhysical(unittest.TestCase):
    def setParameters(self, case_name, url, method, patientId,caseId,msg ):
    ...
    def testgetPhysical(self):
        ...
        paramJson = {"patientId":patientId, "caseId":caseId}
        data = {
    ...
    def checkResult(self):
        ...
        ReadConfig.set_patient('tigejiancha_id', self.info['responseObject']['responseData']['dataList'][0]['id'])
        # 显示返回结果
