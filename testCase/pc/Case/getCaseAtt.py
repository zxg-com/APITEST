...
xls = common.get_xls("pc.xlsx", "病例附件")  # excel取值
...
class getCaseAtt(unittest.TestCase):
    def setParameters(self, case_name, url, method, caseId,isValid,caseAttSpecPic,caseAttSpecVideoPic,caseAttSpecVideo,firstResult,maxResult,attUseFlag,msg ):
        ...
        self.caseAttSpecPic = int(caseAttSpecPic)
        self.caseAttSpecVideoPic = int(caseAttSpecVideoPic)
        self.caseAttSpecVideo = int(caseAttSpecVideo)
        self.firstResult = int(firstResult)
        self.maxResult = int(maxResult)
        self.attUseFlag = int(attUseFlag)
    ...
    def testgetCaseAtt(self):
        ...
        paramJson = {"caseId":caseId,
                     ...
                     "caseAttSpecPic" : self.caseAttSpecPic,
                     "caseAttSpecVideoPic" : self.caseAttSpecVideoPic,
                     "caseAttSpecVideo" : self.caseAttSpecVideo,
                     "firstResult" : self.firstResult,
                     "maxResult" : self.maxResult,
                     "attUseFlag" : self.attUseFlag
        }
        data = {
