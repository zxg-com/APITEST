...
xls = common.get_xls("pc.xlsx", "咨询历史")  # excel取值
...
class getConsHistory(unittest.TestCase):
    def setParameters(self, case_name, url, method, patientId,msg ):
    ...
    def checkResult(self):
        ...
        ReadConfig.set_case('historycaseid',self.info['responseObject']['responseData']['dataList'][0]['caseId'])
        # 显示返回结果
