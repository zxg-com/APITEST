...
xls = common.get_xls("h5.xlsx", "门诊预约设置详情")   #excel取值
...
class clinicset(unittest.TestCase):
    def setParameters(self, case_name,url, method,customerId, hospitalId,msg):
    ...
    def testclinic(self):
        ...
        if self.hospitalId=="":
            self.hospitalId=ReadConfig.get_doctor("hospitalid")
        paramJson = {"customerId":self.customerId,
