...
xls = common.get_xls("h5.xlsx", "获取医生个人简介")   #excel取值
...
class personresume(unittest.TestCase):
    def setParameters(self, case_name,url, method,customerId,visitSiteId,maxResult, msg):
    ...
    def testpersonresume(self):
        ...
        paramJson = {"customerId":self.customerId,"visitSiteId":self.visitSiteId,"maxResult":self.maxResult
                     }
        data = {
