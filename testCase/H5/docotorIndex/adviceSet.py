...
xls = common.get_xls("h5.xlsx", "获取图文问诊信息")   #excel取值
...
class adviceset(unittest.TestCase):
    def setParameters(self, case_name,url, method,customerId, msg):
