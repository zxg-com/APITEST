...
xls = common.get_xls("h5.xlsx", "获取医生认证信息")   #excel取值
...
class getauthinfo(unittest.TestCase):
    def setParameters(self, case_name,url, method,customerId,logoUseFlag, msg):
    ...
    def testgetauthinfo(self):
        ...
        paramJson = {"customerId":self.customerId,"logoUseFlag":self.logoUseFlag
                     }
        data = {
