...
xls = common.get_xls("h5.xlsx", "症状回答")   #excel取值
...
class questionlist(unittest.TestCase):
    def setParameters(self, case_name,url, method, partId	,isValid,firstResult,maxResult,sortType, msg):
    ...
    def testquestionlist(self):
        ...
        # 设置参数
        paramJson = {"partId":self.partId,"isValid":self.isValid,"firstResult":self.firstResult,"maxResult":self.maxResult,
