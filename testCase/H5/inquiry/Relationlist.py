...
xls = common.get_xls("h5.xlsx", "患者列表")   #excel取值
...
class Relationlist(unittest.TestCase):
    def setParameters(self, case_name,url, method, customerId,isValid,firstResult,maxResult,msg):
    ...
    def testRelationlist(self):
        ...
        paramJson = {"customerId":customerId,"isValid":self.isValid,"firstResult":self.firstResult,"maxResult":self.maxResult}
        data = {
