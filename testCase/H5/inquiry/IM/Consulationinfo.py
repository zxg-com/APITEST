...
xls = common.get_xls("h5.xlsx", "获取工单咨询信息")   #excel取值
...
class Consulationinfo(unittest.TestCase):
    def setParameters(self, case_name,url, method, caseId,consultationType,sortType	,firstResult,maxResult,msg):
    ...
    def testConsulationinfo(self):
        ...
        # 设置参数
        paramJson = {"caseId":self.caseId,"consultationType":self.consultationType,
                     "sortType":self.sortType,"firstResult":self.firstResult,"maxResult":self.maxResult}
        data = {
