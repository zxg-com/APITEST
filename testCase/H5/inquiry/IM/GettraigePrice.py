...
xls = common.get_xls("h5.xlsx", "获取分诊医生服务时间")   #excel取值
...
class GettraigePrice(unittest.TestCase):
    def setParameters(self, case_name,url, method, visitSiteId,maxResult,id,msg):
