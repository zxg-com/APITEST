...
xls = common.get_xls("h5.xlsx", "获取imtoken")   #excel取值
...
class GetImtoken(unittest.TestCase):
    def setParameters(self, case_name,url, method, firstResult,maxResult,msg):
    ...
    def testGetImtoken(self):
        ...
        # 设置参数
        paramJson = {"firstResult":self.firstResult,"maxResult":self.maxResult
                     }
        data = {
