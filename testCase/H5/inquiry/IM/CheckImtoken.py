...
xls = common.get_xls("h5.xlsx", "imtoken检查")   #excel取值
...
class CheckImtoken(unittest.TestCase):
    def setParameters(self, case_name,url, method, accid,patientName,msg):
    ...
    def testCheckImtoken(self):
        ...
        paramJson = {"accid":"0_"+caseid,"patientName":patientId
                     }
        data = {
    ...
    def checkResult(self):
        ...
        self.assertEqual(self.info['responseObject']['responseCode'],"200" )
