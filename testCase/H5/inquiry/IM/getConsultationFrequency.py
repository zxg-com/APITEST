...
xls = common.get_xls("h5.xlsx", "IM剩余次数查询")   #excel取值
...
class getConsultationFrequency(unittest.TestCase):
    def setParameters(self, case_name,url, method,caseId,isValid,consultationType,firstResult,maxResult,msg):
    ...
    def testgetConsultationFrequency(self):
        ...
        # 设置参数
        paramJson = {"caseId":self.caseId,"isValid":self.isValid,"consultationType":self.consultationType,
