...
xls = common.get_xls("h5.xlsx", "患者端-校验是否上传过影像资料")   #excel取值
...
class Checkatt(unittest.TestCase):
    def setParameters(self, case_name,url, method,patientCustomerId, msg):
