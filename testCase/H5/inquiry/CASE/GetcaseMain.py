...
xls = common.get_xls("h5.xlsx", "获取病例主诉")   #excel取值
...
class GetcaseMain(unittest.TestCase):
    def setParameters(self, case_name,url, method,caseId,patientId,msg):
    ...
    def testGetcaseMain(self):
        ...
        # 设置参数
        paramJson = {"caseId":self.caseId,"patientId":self.patientId
                     }
        data = {
