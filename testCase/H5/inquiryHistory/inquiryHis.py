...
xls = common.get_xls("h5.xlsx", "问诊历史")   #excel取值
...
class inquiryHis(unittest.TestCase):
    def setParameters(self, case_name,url, method, patientCustomerId,isValid,firstResult,maxResult,logoUseFlag,msg):
    ...
    def testinquiryHis(self):
        ...
        # 设置参数
        patientCustomerId = ReadConfig.get_patient('patient_customerid')
        paramJson = {"patientCustomerId":patientCustomerId,
                    "isValid":self.isValid,
                    "firstResult":self.firstResult,
                    "maxResult":self.maxResult,
                    "logoUseFlag":self.logoUseFlag}
