...
xls = common.get_xls("h5.xlsx", "搜索医院")   #excel取值
...
class Searchhospital(unittest.TestCase):
    def setParameters(self, case_name,url, method,isValid,firstResult,maxResult,cityId	,isSolr	,hospitalName, msg):
        ...
        self.isSolr = str(isSolr)
        self.hospitalName = str(hospitalName)
    ...
    def testSearchhospital(self):
        ...
        # 设置参数
        paramJson = {"isValid":self.isValid,"firstResult":self.firstResult,"maxResult":self.maxResult,"cityId":self.cityId,"isSolr":self.isSolr,"hospitalName":self.hospitalName
                     }
        data = {
