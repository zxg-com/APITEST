...
xls = common.get_xls("h5.xlsx", "地区列表")   #excel取值
...
class RegionList(unittest.TestCase):
    def setParameters(self, case_name,url, method, isValid,firstResult,maxResult,treeLevel,parentId,msg):
    ...
    def testRegionList(self):
        ...
        # 设置参数
        paramJson = {"parentId":self.parentId,"isValid":self.isValid,"firstResult":self.firstResult,"maxResult":self.maxResult,"treeLevel":self.treeLevel}
        data = {
