...
xls = common.get_xls("h5.xlsx", "广告位列表")   #excel取值
...
class getadlist(unittest.TestCase):
    def setParameters(self, case_name,url, method,siteId,channelId,platformId,positionId,msg):
